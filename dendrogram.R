...
topic_keys = read_delim("./lda/topic_keys.txt", delim = "\t", col_names = c("id", "dirichlet", "topic"))

doc_topics = read_delim("./lda/doc_topics.txt", delim = "\t", col_names = c("id", "document",
                                                                            topic_keys$id))
